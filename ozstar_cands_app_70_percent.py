...
png_path = '/media/vishnu/htru_candidates/vishnu/ozstar_cands/70_percent_massive_dm_not_andrew_cherry_beam_discovery_and_redetections/'
df = pd.read_csv('selected_cands_above_70_percent_metadata_not_andrew_cherry_discovery_and_redetection_beams_modified_header.csv', index_col=False)
...
if not os.path.exists('user_classification_70_percent_not_andrew_cherry_discovery_and_redetection.csv'):
    with open('user_classification_70_percent_not_andrew_cherry_discovery_and_redetection.csv', 'w') as outfile:
...
def update_user_classification_database(pics_value, pulsar_button, harmonic_button, rfi_button, class_a_button, class_b_button, n_clicks, next_button):
    ...
    with open('user_classification_70_percent_not_andrew_cherry_discovery_and_redetection.csv','a') as f:
