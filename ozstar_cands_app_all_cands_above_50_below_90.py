...
png_path = '/media/vishnu/htru_candidates/vishnu/ozstar_cands/all_cands_above_50_percent_below_90_percent/'
df = pd.read_csv('all_cands_above_50_percent_metadata_modified_header.csv', index_col=False)
...
if not os.path.exists('user_classification_all_cands_above_50_below_90.csv'):
    with open('user_classification_all_cands_above_50_below_90.csv', 'w') as outfile:
...
df2 = pd.read_csv('user_classification_all_cands_above_50_below_90.csv')
...
def update_user_classification_database(pics_value, pulsar_button, harmonic_button, rfi_button, class_a_button, class_b_button, n_clicks, next_button):
    ...
    with open('user_classification_all_cands_above_50_below_90.csv','a') as f:
