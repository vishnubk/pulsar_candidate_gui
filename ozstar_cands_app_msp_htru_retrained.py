...
png_path = '/media/vishnu/htru_candidates/vishnu/ozstar_cands/latest_msp_candidates_div16_htru_retrained_topo/'
#df = pd.read_csv('msp_search_candidates_above_50_percent_htru_retrained_28_jan.csv', index_col=False)
df = pd.read_csv('msp_search_candidates_above_70_percent_htru_retrained_16_Mar_topo.csv', index_col=False)
